...
export const CASE_TYPES: CaseTypeMeta[] = [
  ...
  // ════════════════════════════════════════════════════════════════
  // Court/ICE/CBP — todos con agency_override para que filtros UI los muestren
  // bajo la agencia correcta (sin override caerían a USCIS/Otros por inferAgency).
  { key: "eoir-removal-240",     formNumber: "I-862",    shortLabel: "Remoción · Sección 240",      label: "I-862 · Remoción (Sección 240)",                  category: "court-removal", description: "Proceso de remoción ante Juez de Inmigración (NTA)",          searchTerms: ["remocion","removal","nta","i862","seccion 240","corte","deportacion"], agency_override: "EOIR" },
  ...
  { key: "ice-bond",             formNumber: "Bond",     shortLabel: "Bond · Audiencia fianza",     label: "Bond · Audiencia de fianza (ICE)",                category: "court-removal", description: "Solicitud de redeterminación de fianza para liberación",      searchTerms: ["bond","fianza","liberacion","detenido","ice","audiencia"], agency_override: "ICE" },
  { key: "ice-stay-removal",     formNumber: "I-246",    shortLabel: "I-246 · Stay of removal",     label: "I-246 · Suspensión de deportación",               category: "court-removal", description: "Solicitud administrativa de stay ante ICE",                   searchTerms: ["stay","suspension","deportacion","i246","ice"], agency_override: "ICE" },
  { key: "cbp-expedited-removal",formNumber: "Expedited Removal", shortLabel: "Expedited Removal",  label: "Expedited Removal · INA 235 (CBP)",               category: "court-removal", description: "Remoción acelerada en puerto de entrada",                     searchTerms: ["expedited","removal","ina 235","puerto","cbp","acelerada"], agency_override: "ICE" },
