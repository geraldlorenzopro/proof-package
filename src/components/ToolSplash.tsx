...
const ACCENT_STYLES: Record<ToolAccentVariant, {
  ...
  cyan: {
    ...
    btnClass: "bg-cyan-400 text-background hover:bg-cyan-400/90",
    radialGlow: "bg-[radial-gradient(ellipse_at_top_right,_#22D3EE,_transparent_70%)]",
    disclaimerBg: "bg-cyan-400/10",
    disclaimerBorder: "border-cyan-400/20",
