...
const TEMPLATE_GROUPS: { prefix: string; label: string; icon: string }[] = [
  ...
  { prefix: "FULL-AOS-F", label: "FULL AOS — F2A (Concurrente)", icon: "🔵" },
  { prefix: "AOS-ONLY", label: "AOS — Solo Ajuste (Petición Aprobada)", icon: "📋" },
  { prefix: "AOS-K", label: "AOS — K-1 Prometido(a) (I-129F Aprobada)", icon: "💍" },
  { prefix: "VAWA", label: "VAWA — Auto-Petición", icon: "🛡️" },
  { prefix: "U-Visa", label: "U-Visa — Víctima de Crimen", icon: "🔒" },
  { prefix: "Waiver", label: "Perdón / Waiver", icon: "⚖️" },
  { prefix: "Remove-Conditions", label: "Remoción de Condiciones (I-751)", icon: "📝" },
  { prefix: "Fiance", label: "Visa de Prometido(a) (I-129F)", icon: "💍" },
  { prefix: "Replace", label: "Reemplazo / Renovación de Residencia", icon: "🔄" },
  { prefix: "Cancel", label: "Cancelación de Remoción", icon: "🚫" },
  { prefix: "TPS", label: "TPS — Protección Temporal", icon: "🌎" },
  { prefix: "DACA", label: "DACA — Acción Diferida", icon: "📋" },
  { prefix: "Asylum", label: "Asilo", icon: "🏠" },
  { prefix: "Citizen", label: "Ciudadanía (N-600)", icon: "🇺🇸" },
  { prefix: "Natural", label: "Naturalización (N-400)", icon: "🗽" },
];
