...
export default function HubTeamWidget({ accountId: _accountId }: Props) {
  ...
  return (
    <section className="rounded-2xl px-6 py-5 border border-cyan-accent/20 bg-gradient-to-br from-ai-blue/[0.04] to-cyan-accent/[0.04] backdrop-blur-sm">
      <div className="flex items-end justify-between mb-4 flex-wrap gap-2">
        <div>
          <p className="text-[10px] uppercase tracking-[0.2em] text-cyan-accent/80 font-mono font-semibold mb-1">
        ...
        {AGENTS.map(agent => {
          ...
          return (
            <button
              ...
              className="text-left bg-white/[0.03] border border-cyan-accent/15 hover:border-cyan-accent/40 hover:bg-cyan-accent/5 rounded-xl p-3 transition-all group"
            >
              ...
              <div className="font-bold text-sm text-foreground font-sora">{agent.name}</div>
              <div className="text-[10px] text-cyan-accent uppercase tracking-wider font-mono font-semibold mt-0.5">
                {agent.role}
              </div>
              ...
              <div className="mt-2.5 pt-2 border-t border-border/30 flex items-center justify-between">
                ...
                <span className="text-[10px] text-cyan-accent opacity-0 group-hover:opacity-100 transition-opacity">
                  Abrir →
                </span>
              </div>
            </button>
      ...
      <div className="mt-4 pt-3 border-t border-border/30 flex items-center justify-between gap-3 flex-wrap">
        ...
        <button
          ...
          className="text-[11px] font-semibold text-cyan-accent/80 hover:text-cyan-accent transition-colors flex items-center gap-1 shrink-0"
        >
          Gestionar equipo
