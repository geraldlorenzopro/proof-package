                  ...
                  <div className="space-y-1">
                    {pendingTasks.slice(0, 3).map((t) => (
                      ...
                      >
                        ...
                        >
                          <Square className="w-3.5 h-3.5 text-muted-foreground hover:text-foreground transition-colors" />
                        </button>
                        <div className="flex-1 min-w-0">
                          <p className="truncate text-foreground group-hover:text-foreground/90 transition-colors">{t.title}</p>
                          {t.assigned_to_name && (
                    ...
                    <div className="flex items-center gap-2 pl-1 flex-wrap pt-1">
                      ...
                      <Popover open={assigneeOpen} onOpenChange={setAssigneeOpen}>
                        <PopoverTrigger asChild>
                          ...
                          >
                            <UserRound className="w-3 h-3 text-foreground" />
