  ...
  return (
    <>
      ...
      >
        ...
        <kbd className="hidden sm:inline text-[9px] font-mono px-1.5 py-0.5 rounded border border-border/40 bg-background/50 text-muted-foreground/40 group-hover:text-muted-foreground/60">
          ⌘K
        </kbd>
      </button>
