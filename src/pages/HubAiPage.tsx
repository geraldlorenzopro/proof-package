...
const TOOLS = [
  ...
  { label: "Visa Evaluator B1/B2", icon: Globe, path: "/tools/visa-evaluator", color: "text-emerald-400", bg: "bg-emerald-500/10", border: "border-emerald-500/20" },
  { label: "Agente VAWA", icon: Shield, path: "/tools/vawa/screener", color: "text-rose-400", bg: "bg-rose-500/10", border: "border-rose-500/20" },
  { label: "Checklist VAWA", icon: CheckSquare, path: "/tools/vawa/checklist", color: "text-pink-400", bg: "bg-pink-500/10", border: "border-pink-500/20" },
  { label: "Calculadora CSPA", icon: Calculator, path: "/tools/cspa", color: "text-amber-400", bg: "bg-amber-500/10", border: "border-amber-500/20" },
  { label: "Affidavit I-864", icon: FileText, path: "/tools/affidavit", color: "text-orange-400", bg: "bg-orange-500/10", border: "border-orange-500/20" },
  { label: "USCIS Analyzer", icon: FileSearch, path: "/tools/uscis-analyzer", color: "text-purple-400", bg: "bg-purple-500/10", border: "border-purple-500/20" },
  { label: "Checklist Generator", icon: Clipboard, path: "/tools/checklist", color: "text-cyan-400", bg: "bg-cyan-500/10", border: "border-cyan-500/20" },
  { label: "Evidence Tool", icon: Camera, path: "/tools/evidence", color: "text-indigo-400", bg: "bg-indigo-500/10", border: "border-indigo-500/20" },
  { label: "Interview Simulator", icon: Zap, path: "/tools/interview-simulator", color: "text-yellow-400", bg: "bg-yellow-500/10", border: "border-yellow-500/20" },
];
