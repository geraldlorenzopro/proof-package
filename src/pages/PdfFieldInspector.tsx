...
export default function PdfFieldInspector() {
  ...
  useEffect(() => {
    ...
    inspect("/forms/MyFormSolution_I765.pdf", setFields2, setError2);
  }, []);
  ...
  return (
    <div className="p-4 max-w-6xl mx-auto">
      ...
      {renderTable(fields1, error1, "Gerald_L_s_I-765.pdf (Our Template)")}
      {renderTable(fields2, error2, "MyFormSolution_I765.pdf (Competitor - with barcodes)")}
    </div>
  );
}
