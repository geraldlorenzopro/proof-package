...
BEGIN
  ...
  INSERT INTO public.case_tasks
    (case_id, account_id, created_by, assigned_to, title, description, task_type, status, priority, visibility, due_date)
  VALUES
    (v_c3, v_account_id, v_user_id, v_user_id,
    ...
    (v_c4, v_account_id, v_user_id, v_user_id,
    ...
    (v_c5, v_account_id, v_user_id, v_user_id,
    ...
    (v_c6, v_account_id, v_user_id, v_user_id,
    ...
    (v_c9, v_account_id, v_user_id, v_user_id,
    ...
    (v_c10, v_account_id, v_user_id, v_user_id,
    ...
    (v_c11, v_account_id, v_user_id, v_user_id,
    ...
    (v_c12, v_account_id, v_user_id, v_user_id,
  ...
  VALUES
    ...
    (v_c6, v_account_id, v_user_id, 'Paralegal',
     ...
     'general', 'team', false, now() - interval '3 days'),
    (v_c6, v_account_id, v_user_id, 'Attorney',
    ...
    (v_c8, v_account_id, v_user_id, 'Attorney',
    ...
    (v_c11, v_account_id, v_user_id, 'Attorney',
