...
BEGIN
  IF NEW.journey_step IS NOT NULL AND NEW.journey_step NOT IN (
    'cliente-nuevo','esperando-cuestionario','esperando-documentos','preparando-paquete',
    'pendiente-revision','enviado','confirmado','en-espera','pide-mas-info',
    'cita-programada','aprobado','negado'
  ) THEN
